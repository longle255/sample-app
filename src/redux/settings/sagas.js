...
export default function* rootSaga() {
  yield all([
    takeEvery(SettingActions.CHANGE_SETTING, CHANGE_SETTING),
    takeEvery(SettingActions.SET_PRIMARY_COLOR, SET_PRIMARY_COLOR),
    takeEvery(SettingActions.SET_THEME, SET_THEME),
